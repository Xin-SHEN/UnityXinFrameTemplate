...
public class MP_MultiScreen : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //create a render texture for pre camera 
    ...
    void move_ctrl_pt(int[] move_dir)
    {
        ...
        int dst_screen_id = global_array_foucs_col / (COLUMNS + 1);
    ...
    void win_color(int w_id)
    {
        ...
        GUI.Label(new Rect(5, 20, 20, 30), "R");
        RGB_base.x = GUI.HorizontalSlider(new Rect(25, 25, 500, 30), RGB_base.x, -1f, 1f);

        GUI.Label(new Rect(5, 50, 20, 30), "G");
        RGB_base.y = GUI.HorizontalSlider(new Rect(25, 55, 500, 30), RGB_base.y, -1f, 1f);

        GUI.Label(new Rect(5, 80, 20, 30), "B");
        RGB_base.z = GUI.HorizontalSlider(new Rect(25, 85, 500, 30), RGB_base.z, -1f, 1f);
        ...
        GUI.Label(new Rect(5, 110, 60, 30), "Gamma");
        float old_edge_gamma = edge_gamma;
        edge_gamma = GUI.HorizontalSlider(new Rect(65, 115, 470, 30), edge_gamma, 0f, 1f);
    ...
    Rect windowRect = new Rect(20, 20, 550, 180);
    ...
    void Update()
    {
        ...
        {
            getActiveScreen().change_edge(0, ref edge_gamma);
        }

        if (Input.GetKeyUp(KeyCode.Alpha2))
        {
            getActiveScreen().change_edge(1, ref edge_gamma);
        }

        if (Input.GetKeyUp(KeyCode.Alpha3))
        {
            getActiveScreen().change_edge(2, ref edge_gamma);
        }
        if (Input.GetKeyUp(KeyCode.Alpha4))
        {
            getActiveScreen().change_edge(3, ref edge_gamma);
        }
